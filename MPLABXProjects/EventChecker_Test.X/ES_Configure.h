...
#define POSTFUNCTION_FOR_KEYBOARD_INPUT PostEventCheckerService
...
#define TIMER2_RESP_FUNC PostEventCheckerService
...
#if NUM_SERVICES > 2
// the header file with the public fuction prototypes
#define SERV_2_HEADER "SensorTestFSM.h"
// the name of the Init function
#define SERV_2_INIT InitSensorTest
// the name of the run function
#define SERV_2_RUN RunSensorTest
// How big should this services Queue be?
