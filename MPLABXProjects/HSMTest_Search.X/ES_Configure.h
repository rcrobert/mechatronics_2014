...
#define POSTFUNCTION_FOR_KEYBOARD_INPUT PostApproachHSM
...
#define EVENT_NAMES(EVENT) \
    ...
    EVENT(BUMPER)  /* Bump sensors triggered */ \
    EVENT(BEACON_FOUND) /* Beacon detector found signal */ \
    EVENT(BEACON_LOST) /* Beacon detector lost signal*/ \
    EVENT(TAPE) /* Tape sensors changed */ \
    EVENT(TRACK_FOUND) /* Track wire found signal */ \
    EVENT(TRACK_LOST) /* Track wire lost signal */ \
    EVENT(CHILD_DONE) /* Sub state machine completed its task */ \
...
#define EVENT_CHECK_HEADER "DummyEventChecker.h"
...
#define TIMER2_RESP_FUNC PostApproachHSM
#define TIMER3_RESP_FUNC PostApproachHSM
#define TIMER4_RESP_FUNC PostEventCheckerService
#define TIMER5_RESP_FUNC PostApproachHSM
...
#define APPROACH_HSM_TIMER 2
#define RAM_SUB_HSM_TIMER 3
#define EVENT_CHECKER_TIMER 4
#define STALL_TIMER 5
...
#if NUM_SERVICES > 2
// the header file with the public fuction prototypes
#define SERV_2_HEADER "ApproachHSM.h"
// the name of the Init function
#define SERV_2_INIT InitApproachHSM
// the name of the run function
#define SERV_2_RUN RunApproachHSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public fuction prototypes
#define SERV_3_HEADER "EventCheckerService.h"
// the name of the Init function
#define SERV_3_INIT InitEventCheckerService
// the name of the run function
#define SERV_3_RUN RunEventCheckerService
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public fuction prototypes
#define SERV_4_HEADER "EventCheckerService.h"
// the name of the Init function
#define SERV_4_INIT InitEventCheckerService
// the name of the run function
#define SERV_4_RUN RunEventCheckerService
// How big should this services Queue be?
