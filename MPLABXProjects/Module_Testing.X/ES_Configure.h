...
#define EVENT_NAMES(EVENT) \
    ...
    EVENT(BEACON) /* Beacon detector triggered */ \
    EVENT(TAPE) /* Tape sensor triggered */ \
...
#define EVENT_CHECK_LIST  CheckSensors
...
#define TIMER10_RESP_FUNC TIMER_UNUSED  // Not unused, used by EventChecker
