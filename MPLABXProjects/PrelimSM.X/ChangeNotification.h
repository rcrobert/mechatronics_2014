 ...
 *
 * NOTE: Module is limited by the CN delay of ~17us and a ~40us execution time
 ...
 */
char CN_AttachInterrupt(CN, void (*)(), CN_INTTYPE);
 ...
 * @author rcrobert 2014.11.16
 */
char CN_DetachInterrupt(CN, CN_INTTYPE);
